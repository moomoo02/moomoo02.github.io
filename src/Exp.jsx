          ...
          {timelineElements.map((element) => {
            ...
            return (
              <VerticalTimelineElement
                ...
                >
                <img class="w-96 h-72" src={element.img}></img>
                <h3 class="font-sans font-bold">
                  {element.title} 
                </h3>
                <h5 class="font-sans" className="vertical-timeline-element-subtitle">
                  {element.location}
                </h5>
                <p class="font-sans" id="description">{element.description}</p>
                {showButton && (
                  <a
                    className={`button ${
